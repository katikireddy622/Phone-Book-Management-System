<?php
	...
	$uids = $_SESSION['UID'];
	$row = mysql_fetch_array(mysql_query("SELECT count(*) FROM mapping where uid=$uids"));
	$personsCount = $row[0];
?>
<html>
	<head>
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card">
	                    <ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#recycle" aria-controls="recycle" role="tab" data-toggle="tab">Recycle</a></li>
	                    ...
	                    <div class="tab-content">
	                        ...
	                        <div role="tabpanel" class="tab-pane" id="recycle">
	                        	<?php include('tab_contents/recycle.php'); ?>
	                        </div>
	                    </div>
                    </div>
				</div>
		...
		<script>
			$(document).ready(function() {
				...
				$("button").click(function(event){
					var id = event.target.id;					
					if($.isNumeric(id)){
						if(confirm("Are sure to restore?")){
							$.ajax({
						        url: 'tasks/recycle/',
						        type: 'POST',
						        data: 'id='+id,
